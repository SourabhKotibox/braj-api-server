  ...
  const templates = [
    {
      ...
      emailSubject: 'Welcome to Braj Cinema TV 🎬',
      emailTemplate:
        `<p style="margin:0 0 16px;">Hello <strong>[[ user_name ]]</strong>,</p>` +
        `<p style="margin:0 0 16px;">Welcome to <strong>Braj Cinema TV</strong>! Your account has been created successfully.</p>` +
...
async function seedAudios() {
  ...
  if (count > 0) {
    // Update existing audios with audioQualities if missing
    const audios = await AudioModel.find({ audioQualities: { $exists: false } });
      ...
      if (audio.audioUrl) {
        await AudioModel.updateOne(
          { _id: audio._id },
          {
            $set: {
              audioQualities: [
                { quality: 'low', url: audio.audioUrl, bitrate: 128, size: 0 },
                { quality: 'medium', url: audio.audioUrl, bitrate: 192, size: 0 },
                { quality: 'high', url: audio.audioUrl, bitrate: 320, size: 0 },
              ],
            },
          }
        );
  ...
  const audios = [
    {
      ...
      album: 'Krishna Bhajans Collection',
      description: 'A devotional Krishna bhajan for spiritual peace.',
      thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400&h=400&fit=crop&q=80',
      audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',
      audioQualities: [
        { quality: 'low', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', bitrate: 128, size: 0 },
        { quality: 'medium', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', bitrate: 192, size: 0 },
        { quality: 'high', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', bitrate: 320, size: 0 },
      ],
      duration: 320,
      tags: ['bhajan', 'krishna', 'devotional'],
      status: 'published' as const,
      views: 125000,
      likes: 8500,
      shares: 2100,
    ...
    },
    {
      ...
      description: 'A melodious Radhe Radhe bhajan.',
      thumbnail: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=400&h=400&fit=crop&q=80',
      audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',
      audioQualities: [
        { quality: 'low', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', bitrate: 128, size: 0 },
        { quality: 'medium', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', bitrate: 192, size: 0 },
        { quality: 'high', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', bitrate: 320, size: 0 },
      ],
      duration: 280,
      tags: ['bhajan', 'radha', 'devotional'],
      status: 'published' as const,
      views: 95000,
      likes: 6200,
      shares: 1800,
    ...
    },
    {
      ...
      artist: 'Hariharan',
      album: 'Shiva Chants',
      description: 'The powerful Shiva Tandava Stotram rendition.',
      thumbnail: 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=400&h=400&fit=crop&q=80',
      audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',
      audioQualities: [
        { quality: 'low', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', bitrate: 128, size: 0 },
        { quality: 'medium', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', bitrate: 192, size: 0 },
        { quality: 'high', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', bitrate: 320, size: 0 },
      ],
      duration: 420,
      tags: ['shiva', 'stotram', 'chant'],
      status: 'published' as const,
      views: 150000,
      likes: 12000,
      shares: 3500,
    ...
    },
    {
      ...
      description: 'The sacred Hanuman Chalisa with music.',
      thumbnail: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=400&h=400&fit=crop&q=80',
      audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3',
      audioQualities: [
        { quality: 'low', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', bitrate: 128, size: 0 },
        { quality: 'medium', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', bitrate: 192, size: 0 },
        { quality: 'high', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', bitrate: 320, size: 0 },
      ],
      duration: 380,
      tags: ['hanuman', 'chalisa', 'devotional'],
      status: 'published' as const,
      views: 200000,
      likes: 18000,
      shares: 5000,
    ...
    },
    {
      ...
      album: 'Vedic Chants',
      description: 'The sacred Gayatri Mantra chanting.',
      thumbnail: 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=400&h=400&fit=crop&q=80',
      audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3',
      audioQualities: [
        { quality: 'low', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', bitrate: 128, size: 0 },
        { quality: 'medium', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', bitrate: 192, size: 0 },
        { quality: 'high', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', bitrate: 320, size: 0 },
      ],
      duration: 600,
      tags: ['mantra', 'vedic', 'chant'],
      status: 'published' as const,
      views: 180000,
      likes: 15000,
      shares: 4200,
  ...
  logger.info('Seeded 5 sample audio tracks');
}

async function seedVideoMusics() {
  const count = await VideoMusicModel.countDocuments();
  if (count > 0) return;

  const videoMusics = [
    {
      title: 'Krishna Music Video',
      artist: 'Kailash Kher',
      album: 'Braj Cinema Music Videos',
      description: 'A beautiful Krishna music video with visuals of Vrindavan.',
      thumbnail: 'https://images.unsplash.com/photo-1504898770365-14faca6a7320?w=400&h=600&fit=crop&q=80',
      coverImage: 'https://images.unsplash.com/photo-1504898770365-14faca6a7320?w=800&h=400&fit=crop&q=80',
      bannerImage: 'https://images.unsplash.com/photo-1504898770365-14faca6a7320?w=1200&h=600&fit=crop&q=80',
      videoUrl: 'https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8',
      duration: 240,
      tags: ['krishna', 'music video', 'devotional'],
      status: 'published' as const,
      processingStatus: 'ready' as const,
      views: 85000,
      likes: 6200,
    ...
    },
    {
      ...
      album: 'Braj Cinema Music Videos',
      description: 'A devotional dance video of Radha Krishna.',
      thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400&h=600&fit=crop&q=80',
      coverImage: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&h=400&fit=crop&q=80',
      bannerImage: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=1200&h=600&fit=crop&q=80',
      videoUrl: 'https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8',
      duration: 300,
      tags: ['radha krishna', 'dance', 'devotional'],
      status: 'published' as const,
      processingStatus: 'ready' as const,
      views: 72000,
      likes: 5100,
    ...
    {
      title: 'Shiva Tandava Video',
      artist: 'Shankar Mahadevan',
      album: 'Shiva Music Videos',
      description: 'A powerful Shiva Tandava music video.',
      thumbnail: 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=400&h=600&fit=crop&q=80',
      coverImage: 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=800&h=400&fit=crop&q=80',
      bannerImage: 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=1200&h=600&fit=crop&q=80',
      videoUrl: 'https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8',
      duration: 280,
      tags: ['shiva', 'tandava', 'music video'],
      status: 'published' as const,
      processingStatus: 'ready' as const,
      views: 95000,
      likes: 7800,
    ...
    },
    {
      ...
      description: 'A festive Ganesh Chaturthi music video.',
      thumbnail: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=400&h=600&fit=crop&q=80',
      coverImage: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=800&h=400&fit=crop&q=80',
      bannerImage: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=1200&h=600&fit=crop&q=80',
      videoUrl: 'https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8',
      duration: 260,
      tags: ['ganesh', 'chaturthi', 'festival'],
      status: 'published' as const,
      processingStatus: 'ready' as const,
      views: 78000,
      likes: 6000,
  ...
  await VideoMusicModel.insertMany(videoMusics);
  logger.info('Seeded 5 sample video music tracks');
}
