    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            fastify.get('/', function (request, reply) { return __awaiter(_this, void 0, void 0, function () {
                var user, dbUser, query, notifications, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            ...
                            return [4 /*yield*/, User_1.UserModel.findById(user.id)];
                        case 1:
                            dbUser = _a.sent();
                            if (!dbUser)
                            ...
                            query = {
                                ...
                                $or: [
                                    { targetAudience: 'all' },
                                    { targetUserIds: new mongoose_1.default.Types.ObjectId(user.id) },
                                ]
                            };
                            ...
                            return [4 /*yield*/, Notification_1.NotificationModel.find(query)
                                    .sort({ createdAt: -1 })
                                    .limit(20)
                                    .lean()];
                        case 2:
