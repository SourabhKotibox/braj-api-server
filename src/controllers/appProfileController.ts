  ...
  try {
    ...
    if (userId) {
      ...
      if (user) {
        ...
        const appName = settings?.platformName || 'Braj Cinema';
    ...
    const platformName = dbSettings?.platformName || 'Braj Cinema TV';
    const contactEmail = dbSettings?.mailFrom || dbSettings?.mailEmail || 'support@brajcinema.tv';
