...
exports.PlanLimitModel = void 0;
var mongoose_1 = __importStar(require("mongoose"));
var PlanLimitSchema = new mongoose_1.Schema({
    planId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'SubscriptionPlan', required: true, unique: true, index: true },
...
exports.PlanLimitModel = mongoose_1.default.model('PlanLimit', PlanLimitSchema);
