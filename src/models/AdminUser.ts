...
export interface IModulePermissions {
  ...
  audio: { canView: boolean; canCreate: boolean; canEdit: boolean; canDelete: boolean };
  videoMusic: { canView: boolean; canCreate: boolean; canEdit: boolean; canDelete: boolean };
  ...
  contests: { canView: boolean; canCreate: boolean; canEdit: boolean; canDelete: boolean };
}
...
const defaultModulePermissions: IModulePermissions = {
  ...
  contests: { canView: true, canCreate: false, canEdit: false, canDelete: false },
};
