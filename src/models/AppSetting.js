...
var AppSettingItemSchema = new mongoose_1.Schema({
...
var AppSettingSchema = new mongoose_1.Schema({
    key: { type: String, required: true, unique: true, default: 'mobile-settings' },
    value: { type: [AppSettingItemSchema], required: true },
}, { timestamps: true });
exports.AppSettingModel = mongoose_1.default.model('AppSetting', AppSettingSchema);
