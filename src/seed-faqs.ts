...
const FAQS_TO_SEED = [
  ...
  },
  {
    ...
    answer: "If your issue isn't covered in these FAQs, feel free to email our customer support team directly at support@brajcinema.tv or initiate a live chat.",
    status: true
  }
];
